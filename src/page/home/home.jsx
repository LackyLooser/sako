...
const Home = () => {
const [{response: partnersResponse ,isLoading: loadingPartners},doFetchPartners] =useFetch (`?_limit=12&_page=2`)
const [{response: manufactResponse ,isLoading: loadingManufact},doFetchManufact] =useFetch (`?_limit=8&_page=5`)
useEffect(()=>{
    doFetchPartners()
    doFetchManufact()
},[])
        ...
        <div className="container">
            <div className="row">
                ...
                {!loadingPartners && partnersResponse && partnersResponse.map(el =>{
                    return (
                        <div className="col-lg-3 col-md-4 col-sm-6 pr-0 pl-0" key={el.id}>
                            <div className="partners_container">
                                <img src={el.url} className="partners_hidden"/>
                                <span className="partners_company">Название компании</span>
    ...
    <SliderItem bg={"bestseller bestseller_new"} title={"Новинки"} apiUrl={`?_limit=12&_page=2`}/>
    <div className="container">
        ...
        <SliderItem bg={"bestseller bestseller_hit"} title={"Хит продаж"} apiUrl={`?_limit=12&_page=2`}/>
                    ...
                    <div className="row">
                        ...
                        {!loadingManufact && manufactResponse &&  manufactResponse.map(el=>{
                            ...
                            <div className="manufacturers_item">
                                <a className="manufacturers_item_link" href="#">
                                    <img src={el.url} alt=""/>
                                </a>
                                <div className="manufacturers_item_company">
                                    <a href="#">Органик лайн</a>
                                </div>
